...
def get_region_data(country_names,country_region_data):
    ...
    for keyval,cval in region_names.items():
        if keyval == "BNL":
            ...
            country_list[keyval]=('LSO','SWZ','ZAF','BWA','AGO','MDG','MOZ','MUS','MWI','NAM','ZMB','ZWE', 'BDI','COM','DJI','ETH','KEN','SYC','TZA','UGA', 'SOM', 'CAF','CMR','COD','COG','GAB','SSD','BEN','BFA','CIV','CPV','GHA','GIN','GMB','GNB', 'LBR','NGA', 'SEN', 'SLE', 'STP', 'TGO','DZA','EGY','ERI','LBY','MAR','MLI','MRT','NER','SDN','TCD','TUN', 'GNQ', 'RWA', 'ESH')
        elif keyval == "NOA":  # North America
            country_list[keyval]=("BLZ","CAN","CRI","CUB","DMA","DOM","SLV","GRD","GTM","HTI","MEX","NIC","PAN","USA", "HND")
        elif keyval == "SOA":  # South America
            country_list[keyval]=("ARG","BOL","BRA","CHL","COL","ECU","GUY","PRY","PER","SUR","URY","VEN", "GUF")
        elif keyval == "AIS":  # Asia
            country_list[keyval]=("AFG","ARM","AZE","BHR","BGD","BTN","BRN","KHM","CHN","GEO","IND","IDN","IRN","IRQ","ISR","JPN","JOR","KAZ","KWT","KGZ","LAO","LBN","MYS","MNG","MMR","NPL","PRK","OMN","PAK","PSE","PHL","QAT","RUS","SAU","SGP","KOR","LKA","SYR","TWN","TJK","THA","TLS","TUR","TKM","ARE","UZB","VNM","YEM","PNG")
